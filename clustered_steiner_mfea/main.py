    ...
    for _ in _tqdm:
        ...
        while(len(tmp_population) >= 2):
            ...
            if parent[0].skill_factors == parent[1].skill_factors or rand < rmp:
                ...
                if parent[0].skill_factors == parent[1].skill_factors:
                    child_1.skill_factors = child_2.skill_factors = parent[0].skill_factors
                else:
                    rand = random.randint(0, 100) / 100.0
                    if rand > 0.5:
                ...
                child_1.skill_factors = parent[0].skill_factors
                child_2.skill_factors = parent[1].skill_factors          
        ...
        _tqdm.set_postfix({"seed":seed,"task_1":min_glob_1, "task_2":min_glob_2})
    with open("task1.txt","a") as f:
        f.write(str(min_glob_1)+"\n")
    with open("task2.txt","a") as f:
        f.write(str(min_glob_2)+"\n")
